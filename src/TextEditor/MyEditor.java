...
public class MyEditor {
    ...
    private void createAndShowGUI() {
        ...
        textPane.addKeyListener(new BulletParaKeyListener());
        textPane.addKeyListener(new NumbersParaKeyListener());
        textPane.addCaretListener(new EditorCaretListener());
...
//        menuEdit.add(cut);
    ...
    private class BulletActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            StyledDocument doc = getEditorDocument();
            Element paraEle = doc.getParagraphElement(textPane.getSelectionStart());
            ...
            } while (paraEleEnd <= textPane.getSelectionEnd());
            // BULLETS_PARA_LOOP
    ...
    public class BulletParaKeyListener implements KeyListener {
        ...
        private void doEnterKeyRoutine() {
            ...
            insertBullet(textPane.getCaretPosition(), prevParaEleStart);
        }
    ...
    private void doLeftArrowKeyRoutine(int pos, boolean startTextPos) {
        ...
        Element paraEle =
                getEditorDocument().getParagraphElement(textPane.getCaretPosition());
